...
import style from '../../cli/styles/ContactForm.module.scss'
...
export default () => {
  ...
  return (
    <Fragment>
     ...
     <form className={style.formBox} name="joinForm" id="joinForm" action="/member/v2/join/verify" method="post" novalidate="">
                ...
                <input type="hidden" id="joinToken" name="joinToken" value="c614aae30e3eb874e79abf4076135add01040e94"/>
                ...
                <header className={style.member_header}>
                ...
                <div className={style.join_form}>
                    ...
                    <div class="n-form-set">
                        ...
                        <div class="n-form-icon">
                            <input type="password" class="n-input input" id="password" name="password" minlength="8" autocomplete="new-password" placeholder="비밀번호(숫자,영문,특수문자 조합 최소8자)"/>
                        ...
                        <div class="n-form-icon">
                            <input type="password" class="n-input input" id="confirmPassword" name="confirmPassword" autocomplete="new-password" minlength="8" placeholder="비밀번호 확인"/>
                    ...
                    <div class="n-form-set">
                        ...
                        <input type="text" class="n-input" minlength="4" maxlength="17" id="recommendMemberId" name="recommendMemberId" placeholder="추천인 아이디 입력" value=""/>
                ...
                <div id="joinBtnDiv" class="member-btn">
                    ...
                    <button type="button" class="n-link gtm-catch-click" onclick="location.href='/login/v1/login'" data-gtm-cd-23="not_member" data-gtm-cd-19="button" data-gtm-cd-20="/member/join" data-gtm-cd-21="2" data-gtm-category="not_member" data-gtm-action="client.click" data-gtm-label="비회원구매하기">
                        비회원 구매하기
                    </button>
